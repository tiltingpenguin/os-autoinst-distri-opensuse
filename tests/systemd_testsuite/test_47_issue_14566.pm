...
sub run {
    ...
    assert_script_run './run-integration-tests.sh TEST-47-ISSUE-14566 --run 2>&1 | tee /tmp/testsuite.log', $timeout;
    assert_script_run 'grep "PASS: ...TEST-47-ISSUE-14566" /tmp/testsuite.log';
    script_run './run-integration-tests.sh TEST-47-ISSUE-14566 --clean';
}
